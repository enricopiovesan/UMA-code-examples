...
<div class="subpage-body">
          ...
          <section class="faq-section" data-faq="true">
            ...
            <dl class="faq-list">
              ...
              <dd>WebAssembly is UMA's recommended execution boundary because it's the only portable artifact format that runs identically across browser, edge, server, and workflow environments without recompilation. The architectural model (separating behavior from runtime, expressing contracts as machine-readable descriptors, proving portability) applies regardless of the compilation target. WASM is what makes the portability claim verifiable rather than assumed.</dd>
