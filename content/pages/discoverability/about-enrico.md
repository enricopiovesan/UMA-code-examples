...
<div class="subpage-body">
          ...
          <section>
            ...
            <p>
              Enrico works as a principal platform architect at Autodesk, where he has spent years designing modular systems that must stay coherent across product boundaries, delivery teams, and evolving runtime environments. That context — real systems under delivery pressure, not architecture in theory — is where Universal Microservices Architecture was developed and tested.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Enrico writes on <a href="https://medium.com/the-rise-of-device-independent-architecture">The Rise of Device-Independent Architecture</a> on Medium, covering portable systems, WebAssembly, MCP integration, and the architectural patterns behind UMA. The publication is the primary channel for long-form technical writing, while this site connects the model to the book, examples, and learning path.
            </p>
            <p>
              Universal Microservices Architecture (Apress, 2024) is the main published work. It develops the full methodology from the first portable service through runtime governance, trust boundaries, and AI-native execution patterns. The code examples that accompany the book are published in the <a href="https://github.com/enricopiovesan/UMA-code-examples">UMA-code-examples</a> repository on GitHub.
            </p>
          </section>
