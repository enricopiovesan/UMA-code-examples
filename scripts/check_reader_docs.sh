...
require_heading "$ROOT_DIR/README.md" "What UMA Is"
require_heading "$ROOT_DIR/README.md" "What This Repo Contains"
require_heading "$ROOT_DIR/README.md" "Start Here"
require_heading "$ROOT_DIR/README.md" "Reader Journey"
require_heading "$ROOT_DIR/README.md" "Chapter 13 Call To Action"
require_heading "$ROOT_DIR/README.md" "How To Use The Repo"
