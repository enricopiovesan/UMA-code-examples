...
./scripts/compare_impls.sh lab2-undeclared-permission
...
./scripts/compare_impls.sh lab3-untrusted-dependency
...
./scripts/compare_impls.sh lab4-forbidden-communication
